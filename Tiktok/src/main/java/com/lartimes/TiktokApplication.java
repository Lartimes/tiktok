...
//           搞一个过滤系统 ， 评判用户模型 引入大数据框 互相操作
    ...
    private final VideoScheduledService videoScheduledService;

    public TiktokApplication(VideoScheduledService videoScheduledService) {
        this.videoScheduledService = videoScheduledService;
    }
